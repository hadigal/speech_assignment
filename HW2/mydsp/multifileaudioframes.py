'''
Create a stream of audio frames over multiple files
...
class MultiFileAudioFrames(object):
    ...
    def __init__(self, filelist, adv_ms, len_ms):
        ...
        # creating instance of audioframes class
        self.samplefile = AudioFrames(self.files[0], adv_ms, len_ms)
        self.Fs = self.samplefile.get_Fs() # sampling frequency
    ...
    def get_framelen_samples(self):
        ...
        return self.samplefile.len_N # N = Fs*t; t = 1/f; f = Fs*k/N ==> Freq. domain resp.
    ...
    def get_Fs(self):
        ...
        return self.Fs # sampling frequency
...
class MultiFileIter:
    ...
    def __init__(self, filelist, adv_ms, len_ms, Fs):
        ...
        # HR: creating instance of audioframes class
        self.frame_obj = AudioFrames(self.files[self.idx], adv_ms, len_ms)
        # HR: getting the total number of frames??
